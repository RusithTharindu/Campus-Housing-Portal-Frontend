...
const LandlordLeftLink = (props) => {
  ...
  return (
        <button tabindex="0" className='w-[90%] h-[70px] mt-[15px] rounded-[15px] border border-[#dfdfdf] flex flex-row justify-between items-center ease-in-out duration-300 hover:bg-[#e8e8e8] focus:bg-[#C7C7EC] cursor-pointer' onclick={() => {console.log("Hello")}}>
