            ...
            <div className=" w-[500px] h-[650px] rounded-[20px] flex flex-col items-center justify-center bg-[rgba(0,0,0,0.6)]">
                ...
                <form action="">
                    <div className="w-[400px] mt-[20px]">
                        ...
                        <input type="submit" value="Register" className="w-[100%] h-[40px] bg-[#00868D] text-white font-[600] rounded-[20px] hover:bg-[#069BA2] cursor-pointer transition ease delay-50  active:bg-[#222222] active:border active:border-white"/>
                    </div>
                </form>
